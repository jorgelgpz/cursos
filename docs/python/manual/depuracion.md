...
![Punto de parada en Visual Studio Code](../../assets/imagenes_python/break-point.png)>

Para iniciar la depuración de un programa en VSCode hay que hacer clic sobre el botón ![Visual Studio Code debbuger](../../assets/imagenes_python/debug-button.png) o pulsar la combinación de teclas (Ctr+Shift+D).
...
![Barra de depuración de Visual Studio Code](../../assets/imagenes_python/debbuger-bar.png)
...
![Ventana de estado de variables de Visual Studio Code](../../assets/imagenes_python/debbuger-estado-variables.png)